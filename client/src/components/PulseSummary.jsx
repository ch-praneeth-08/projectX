    ...
    return (
      <div className="premium-card p-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-surface-600">Generating AI analysis...</span>
        </div>
        <p className="mt-2 text-sm text-surface-400">Repository data loaded. AI summary will appear automatically.</p>
      </div>
    );
  }
    ...
    return (
      <div className="premium-card p-6">
        ...
        {summaryError.includes('Ollama') && (
          <p className="mt-2 text-xs text-surface-400">{summaryError}</p>
        )}
      </div>
    );
  }
    ...
    <div className="premium-card overflow-hidden">
      ...
      <div className="p-6 pb-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl ${healthStyle.bg} ${healthStyle.text} border ${healthStyle.border}`}>
            {healthStyle.icon}
            <span className="font-semibold">{summary.overallHealth}</span>
          </div>
          <div className="flex items-center text-surface-400 text-sm gap-1.5">
      ...
      {summary.recommendation && (
        <div className="mx-6 mb-6 bg-gradient-to-r from-brand-50 to-accent-50 border border-brand-200 rounded-xl p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-brand-800 mb-1">Recommendation</h3>
              <p className="text-sm text-brand-700">{summary.recommendation}</p>
            </div>
          </div>
        </div>
      )}
